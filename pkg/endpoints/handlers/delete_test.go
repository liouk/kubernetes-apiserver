...
func TestDeleteCollectionWithNoContextDeadlineEnforced(t *testing.T) {
	...
	// NOTE(dinhxuanvu): The deadline context is kept as a carry-patch.
	// See: https://github.com/openshift/kubernetes-apiserver/commit/a3254734f608b52f71f357317b31770a52f004c5
	// As a result, this check is commented out to ensure the test passes.
